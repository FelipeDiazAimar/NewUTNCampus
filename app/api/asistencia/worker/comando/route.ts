...
//   GET  /api/asistencia/worker/comando?id=X   -> el supervisor consulta si hay comando
//   POST /api/asistencia/worker/comando        -> el supervisor confirma que lo ejecutó
// Ambos con header x-worker-secret = NOTIFICATIONS_WEBHOOK_SECRET.
// Calco de app/api/captcha/comando/route.ts.
